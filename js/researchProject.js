 //研究项目滚动显示效果,滚动条滚动时做什么事
 //用户一滚动，马上调用ajax，请求完数据全部附加dao
 //  window.onscroll = function () {
 //         var researchUrl = window.location.href;
 //           if (researchUrl.match('researchProject\/researchProjectDetail.html')) {
 //             var cardNumebr = $('.current-research-project-card').length;
 //             if (cardNumebr >= 16) {
 //                 return false;
 //             } else {
 //                 function gotoDo(){
 //                    $childCard = '<div class="current-research-project-card">' +
