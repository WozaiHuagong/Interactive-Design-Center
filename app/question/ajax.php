		...
		if ($question_list)
		{
			foreach ($question_list AS $key => $val)
			{
				if ($val['answer_count'])
				{
					...
					$question_list[$key]['shang_info']=$this->model('question')->sum('question_shang','cash','question_id = '.intval($val['question_id']));
					$question_list[$key]['zanzhu_count']=$this->model('question')->count('question_shang','question_id = '.intval($val['question_id']));
				}
			}
		}
