...
com.wiris.js.JsPluginViewer.prototype = {
	...
	,callService: function(mml,servicename) {
		...
		if(com.wiris.js.JsPluginViewer.DEBUG) haxe.Log.trace("Calling: " + url,{ fileName : "JsPluginViewer.hx", lineNumber : 514, className : "com.wiris.js.JsPluginViewer", methodName : "callService"});
		if(com.wiris.js.JsPluginViewer.DEBUG) haxe.Log.trace("POST:" + data,{ fileName : "JsPluginViewer.hx", lineNumber : 516, className : "com.wiris.js.JsPluginViewer", methodName : "callService"});
	...
	,callShowimage: function(mml,img) {
		...
		data = "?formula=" + md5 + "&lang=" + this.lang + "&jsonformat=png";
		if(com.wiris.js.JsPluginViewer.DEBUG) haxe.Log.trace("Calling: " + url,{ fileName : "JsPluginViewer.hx", lineNumber : 454, className : "com.wiris.js.JsPluginViewer", methodName : "callShowimage"});
		if(com.wiris.js.JsPluginViewer.DEBUG) haxe.Log.trace("GET:" + data,{ fileName : "JsPluginViewer.hx", lineNumber : 456, className : "com.wiris.js.JsPluginViewer", methodName : "callShowimage"});
		...
		img.src = "data:image/png;base64," + Std.string(result.pngBase64);
		if(result.height > 0) {
			if(com.wiris.js.JsPluginViewer.DEBUG) haxe.Log.trace(height - baseline,{ fileName : "JsPluginViewer.hx", lineNumber : 477, className : "com.wiris.js.JsPluginViewer", methodName : "callShowimage"});
	...
	,callCreateImage: function(mml,img) {
		...
		data += "&lang=" + this.lang;
		if(this.zoom != 1) data += "&zoom=" + this.zoom;
		if(com.wiris.js.JsPluginViewer.DEBUG) haxe.Log.trace("Calling: " + url,{ fileName : "JsPluginViewer.hx", lineNumber : 380, className : "com.wiris.js.JsPluginViewer", methodName : "callCreateImage"});
		if(com.wiris.js.JsPluginViewer.DEBUG) haxe.Log.trace("POST:" + data,{ fileName : "JsPluginViewer.hx", lineNumber : 382, className : "com.wiris.js.JsPluginViewer", methodName : "callCreateImage"});
		con.open("POST",url,false);
		con.setRequestHeader("Content-type","application/x-www-form-urlencoded; charset=utf-8");
		con.send(data);
		var s = con.responseText;
		...
		if(i >= 0) {
			...
			if(com.wiris.js.JsPluginViewer.DEBUG) haxe.Log.trace(h.get("formula"),{ fileName : "JsPluginViewer.hx", lineNumber : 405, className : "com.wiris.js.JsPluginViewer", methodName : "callCreateImage"});
		...
		if(height > 0) {
			if(com.wiris.js.JsPluginViewer.DEBUG) haxe.Log.trace(height - baseline,{ fileName : "JsPluginViewer.hx", lineNumber : 416, className : "com.wiris.js.JsPluginViewer", methodName : "callCreateImage"});
	...
	,processMathML: function(mml,container) {
		...
		if(com.wiris.js.JsPluginViewer.DEBUG) haxe.Log.trace(img.src,{ fileName : "JsPluginViewer.hx", lineNumber : 346, className : "com.wiris.js.JsPluginViewer", methodName : "processMathML"});
	}
	...
	,doLoad: function() {
		...
		if(this.params.exists("wirispluginperformance") && this.params.get("wirispluginperformance") == "true") this.performanceenabled = true; else this.performanceenabled = false;
