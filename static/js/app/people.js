$(document).ready(function () {	
	...
	AWS.load_list_view(G_BASE_URL + '/people/ajax/user_actions/uid-' + PEOPLE_USER_ID + '__actions-301', $('#bp_custom_actions_articles_more'), $('#contents_custom_actions_articles'));	// 发起的文章-新加

	AWS.load_list_view(G_BASE_URL + '/people/ajax/user_actions/uid-' + PEOPLE_USER_ID + '__actions-302', $('#bp_sortout_actions_articles_more'), $('#contents_sortout_actions_articles'));	// 整理文章-新加

	AWS.load_list_view(G_BASE_URL + '/people/ajax/user_actions/uid-' + PEOPLE_USER_ID + '__actions-303', $('#bp_prize_actions_articles_more'), $('#contents_prize_actions_articles'));	// 有奖文章-新加
