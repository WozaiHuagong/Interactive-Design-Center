$(function()
{
	...
	$('.aw-mod.side-nav a,.sidelist a').click(function () {
	...
	if ($('.sidelist a[rel="' + window.location.hash.replace(/#/g, '') + '"]').attr('href'))
	{
		$('.sidelist a[rel="' + window.location.hash.replace(/#/g, '') + '"]').click();
	}
	else
	{
		$('.sidelist a[rel=all]').click();
	}
