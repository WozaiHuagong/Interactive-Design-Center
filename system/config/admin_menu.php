...
$config[] = array(
    ...
    'children' => array(
        ...
        // array(
        //     'id' => 410,
        //     'title' => AWS_APP::lang()->_t('整理管理'),
        //     'url' => 'admin/sortout/list/'
        // ),
        // array(
        //     'id' => 302,
...
// $config[] = array(
//     'title' => AWS_APP::lang()->_t('信息发布'),
//     'cname' => 'reply',
//     'children' => array(
//         array(
//             'id' => 850,
//             'title' => AWS_APP::lang()->_t('信息列表'),
//             'url' => 'admin/info/list/'
//         ),

//         array(
//             'id' => 851,
//             'title' => AWS_APP::lang()->_t('信息评论'),
//             'url' => 'admin/info/comments/'
//         ),
//         array(
//             'id' => 852,
//             'title' => AWS_APP::lang()->_t('充值管理'),
//             'url' => 'admin/info/charge/'
//         ),
//         array(
//             'id' => 854,
//             'title' => AWS_APP::lang()->_t('提现管理'),
//             'url' => 'admin/info/withdraw/'
//         ),
//         array(
//             'id' => 855,
//             'title' => AWS_APP::lang()->_t('交易明细'),
//             'url' => 'admin/info/flow/'
//         ),
//         array(
//             'id' => 856,
//             'title' => AWS_APP::lang()->_t('广告上下架明细'),
//             'url' => 'admin/info/ad_flow/'
//         ),
//         array(
//             'id' => 857,
//             'title' => AWS_APP::lang()->_t('广告点击明细'),
//             'url' => 'admin/info/ad_click/'
//         ),
//         array(
//             'id' => 858,
//             'title' => AWS_APP::lang()->_t('整理文章打赏'),
//             'url' => 'admin/shang/sortout/'
//         ),
//         array(
//             'id' => 859,
//             'title' => AWS_APP::lang()->_t('问题打赏赞助'),
//             'url' => 'admin/shang/question/'
//         ),
//         array(
//             'id' => 860,
//             'title' => AWS_APP::lang()->_t('回答打赏'),
//             'url' => 'admin/shang/answer/'
//         ),
//         array(
//             'id' => 861,
//             'title' => AWS_APP::lang()->_t('文章打赏'),
//             'url' => 'admin/shang/article/'
//         ),
//         array(
//             'id' => 862,
//             'title' => AWS_APP::lang()->_t('打赏明细'),
//             'url' => 'admin/shang/article/'
//         ),
//         array(
//             'id' => 863,
//             'title' => AWS_APP::lang()->_t('评论打赏'),
//             'url' => 'admin/shang/comment/'
//         ),

//         array(
//             'id' => 853,
//             'title' => AWS_APP::lang()->_t('财务设置'),
